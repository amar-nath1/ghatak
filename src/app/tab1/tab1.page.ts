...
export class Tab1Page {
   public maxDate = moment().subtract(18,'years')
  ...
  constructor(private router: Router , private accountService: AccountsService, private formBuilder: FormBuilder) {
  ...
  onSubmit() {
    if (this.signupForm.valid) {
      ...
      this.accountService.postProfile(this.signupForm.value).subscribe((res) => {
this.getProfilesAfterLogin()
        
      });
    } else {
      alert('form is not valid. Please check')
    }
  }
